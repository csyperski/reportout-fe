...
@Component({
  selector: 'ro-recent-graph',
  styleUrls: ['./recentgraph.component.scss'],
  templateUrl: './recentgraph.component.html',
})
export class RecentGraphComponent extends BaseComponent implements OnInit {
